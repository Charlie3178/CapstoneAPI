...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://qqwjensanktqcu:0525e8659b92794f44cee357fcf5d74feca9d5c7815379e2bec30db061192a58@ec2-18-215-96-22.compute-1.amazonaws.com:5432/db31n01d7ig0e"
...
class Character(db.Model):
    ...
    pname = db.Column(db.String, nullable=True)
    cname = db.Column(db.String, nullable=True)
    pclass = db.Column(db.String, nullable=True)
    ...
    basespeed = db.Column(db.Integer, nullable=True)
    level = db.Column(db.Integer, nullable=True)
    alignment  = db.Column(db.String, nullable=True)
    description = db.Column(db.String, nullable=True)
    biography = db.Column(db.String, nullable=True)
    copper = db.Column(db.Integer, nullable=True)
    silver = db.Column(db.Integer, nullable=True)
    gold = db.Column(db.Integer, nullable=True)
    platinum = db.Column(db.Integer, nullable=True)
